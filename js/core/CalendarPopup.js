...
function CalendarPopup(divName, calId) {
    ...
    c.monthNames = hyf.calendar.displayNames.monthNames;
    c.monthAbbreviations = hyf.calendar.displayNames.monthAbbrs;
    c.dayNames = hyf.calendar.displayNames.dayNames;
    c.dayHeaders = [];
    for (var i = 0; i < c.dayNames.length; ++i) {
        c.dayHeaders[i] = c.dayNames[i].charAt(0);
    }
